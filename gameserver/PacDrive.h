...
// Souldn't need this but I need to find where in the project to define it.
#include <windows.h>
...
PACDRIVE_API VOID __stdcall PacSetCallbacks(USBDEVICE_ATTACHED_CALLBACK pacAttachedCallback, USBDEVICE_REMOVED_CALLBACK pacRemovedCallback);
